...
async function middleware(req) {
    ...
    const publicRoutes = [
        '/',
        '/homepage/:id'
    ]; // Add /homepage/:id as a public route
    // Get session token
    ...
    // Handle user access
    if (role === 'user') {
        if (userRoutes.some((route)=>pathname.startsWith(route)) || /^\/homepage\/[^\/]+$/.test(pathname) // Allow /homepage/[id]
        ) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$spec$2d$extension$2f$response$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].next();
        }
    ...
    // Handle admin access
    if (role === 'admin') {
        if (adminRoutes.some((route)=>pathname.startsWith(route)) || /^\/homepage\/[^\/]+$/.test(pathname) // Allow /homepage/[id]
        ) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$spec$2d$extension$2f$response$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].next();
        }
